# -*- coding: utf-8 -*-
# Description: 核心工具包
# Created: yangyingjie 2019/06/27
# Modified: yangyingjie 2019/06/27; yangyingjie 2019/06/27
            ...
            for field in [x for x in dir(obj)
                ...
                try:
                    if isinstance(data, (str, int, float)):
                        ...
                        # fields[field] = entity.isoformat(sep=' ')
                        fields[field] = data.strftime("%Y-%m-%d %H:%M:%S")
                    elif isinstance(data, datetime.date):
                        # fields[field] = entity.isoformat()
